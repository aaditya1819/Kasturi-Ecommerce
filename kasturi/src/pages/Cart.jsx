          ...
          cartData.map((item,index)=>{
            ...
            return(
              <div key={index} className='grid py-4 border-t border-b text-gray-700 grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4' >
                  ...
                  <input onChange={(e)=> e.target.value === '' || e.target.value === '0' ? null : updateQuantity(item._id,item.size,Number(e.target.value))} className='border w-14 sm:w-20 px-1 sm:px-2 py-1 text-center justify-self-end' type="number" min={1} defaultValue={item.quantity} />
